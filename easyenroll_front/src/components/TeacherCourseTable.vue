...
const fetchData = async () => {
  try {
    //获取已选择的课程列表
    const response = await axios.get('/sel/selection/list/teacher/' + sessionStorage.getItem('account'), {
      params: {
...
const fetchFullData = async () => {
  try {
    //获取已选择的课程列表
    const response = await axios.get('/sel/selection/list/teacher/noPage/' + sessionStorage.getItem('account'))
